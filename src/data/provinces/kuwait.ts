...
export const KUWAIT_PROVINCES = createProvinceFlags('Kuwait', [
  ...
  {
    name: 'Standard of the Emir of Kuwait',
    code: 'kw-roy',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Standard_of_the_Emir_of_Kuwait.svg',
    tags: [],
    status: ""
  }
], 'Asia');
