...
export const VENEZUELA_PROVINCES = createProvinceFlags('Venezuela', [
  ...
  },
  {
    name: 'Táchira',
    code: 've-tac',
    image: 'Bandera_del_Estado_T%C3%A1chira.svg',
    aliases: ['Tachira', 'Estado Tachira', 'Estado Táchira', 'San Cristobal'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Nueva Esparta',
    code: 've-nue',
    image: 'Flag_of_Nueva_Esparta.svg',
    aliases: ['Estado Nueva Esparta', 'Margarita Island', 'Isla de Margarita', 'La Asuncion'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Falcón',
    code: 've-i',
    image: 'Flag_of_Falc%C3%B3n.svg',
    aliases: ['Falcon', 'Estado Falcon', 'Estado Falcón', 'Coro'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Portuguesa',
    code: 've-p',
    image: 'Flag_of_Portuguesa.svg',
    aliases: ['Estado Portuguesa', 'Guanare'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    ...
    code: 've-a',
    image: 'Bandera_de_Caracas.svg',
    aliases: ['Caracas', 'Distrito Capital', 'Capital of Venezuela', 'Santiago de Leon de Caracas'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    ...
    code: 've-fd',
    image: 'https://static.wikia.nocookie.net/vexillology/images/5/56/Flag_of_Federal_Dependencies_of_Venezuela.svg/revision/latest?cb=20250316174402',
    aliases: ['Dependencias Federales', 'Los Roques'],
    tags: [],
    status: ""
  }
], 'South America');
