...
export const CAMEROON_PROVINCES = createProvinceFlags('Cameroon', [


  {
    name: 'Ambazonia / Southern Cameroons (Regional Movement)',
    code: 'cm-amb',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d9/Flag_of_the_Federal_Republic_of_Southern_Cameroons.svg',
    tags: ["blue", "white", "stripes", "horizontal", "canton", "stars", "circle", "bird", "yellow"],
    status: "official"
  },
  {
    name: 'Adamawa',
