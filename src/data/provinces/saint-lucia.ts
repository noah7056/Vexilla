...
export const SAINT_LUCIA_PROVINCES = createProvinceFlags('Saint Lucia', [
  ...
  },
  {
    name: 'Anse La Raye',
    code: 'lc-ray',
    image: 'https://static.wikia.nocookie.net/vexillology/images/e/e8/Flag_of_Anse_la_Raye_Quarter.png/revision/latest?cb=20230525024948',
    tags: [],
    status: ""
  },
  {
    name: 'Canaries',
    code: 'lc-can',
    image: 'https://static.wikia.nocookie.net/vexillology/images/4/4c/Flag_of_Canaries_Quarter.png/revision/latest?cb=20230525025523',
    tags: [],
    status: ""
  },
  {
