...
export const SAINT_KITTS_AND_NEVIS_PROVINCES = createProvinceFlags('Saint Kitts and Nevis', [


  {
    name: 'Nevis (Island)',
    code: 'kn-nev',
    image: 'Flag_of_Nevis.svg',
    tags: [],
    status: ""
  },
  {
    ...
    code: 'kn-lit',
    image: 'https://static.wikia.nocookie.net/vexillology/images/a/a9/Flag_of_Saint_Kitts.svg/revision/latest/scale-to-width-down/1000?cb=20230801130536',
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    ...
    code: 'kn-ccn',
    image: 'https://static.wikia.nocookie.net/vexillology/images/4/46/Flag_of_Christ_Church_Nichola_Town_Parish.png/revision/latest?cb=20230602204312',
    tags: [],
    status: ""
  },
  {
