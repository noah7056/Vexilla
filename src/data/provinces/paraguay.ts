...
export const PARAGUAY_PROVINCES = createProvinceFlags('Paraguay', [
  ...
  },
  {
    name: 'Alto Paraguay',
    code: 'py-ar',
    image: 'https://static.wikia.nocookie.net/vexillology/images/c/ce/Bandera_de_Alto_Paraguay.png/revision/latest?cb=20260822202548',
    aliases: ['Departamento de Alto Paraguay'],
    tags: [],
    status: ""
  },
  {
    name: 'Amambay',
    code: 'py-am',
    image: 'Flag_of_Amambay.svg',
    aliases: ['Departamento de Amambay', 'Pedro Juan Caballero'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Cordillera',
    code: 'py-co',
    image: 'Bandera_del_Departamento_de_Cordillera.JPG',
    aliases: ['Departamento de Cordillera', 'Caacupe'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Misiones',
    code: 'py-mi',
    image: 'Flag_of_Misiones%2C_Paraguay.svg',
    aliases: ['Departamento de Misiones', 'San Juan Bautista'],
    tags: [],
    status: ""
  },
  {
