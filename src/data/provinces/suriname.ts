...
export const SURINAME_PROVINCES = createProvinceFlags('Suriname', [
  ...
  },
  {
    name: 'Coronie',
    code: 'sr-cor',
    image: 'https://static.wikia.nocookie.net/vexillology/images/f/f2/Coronie.png/revision/latest/scale-to-width-down/1000?cb=20251003092123',
    aliases: ['District Coronie', 'Totness'],
    tags: [],
    status: ""
  },
  {
