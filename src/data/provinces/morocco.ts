...
export const MOROCCO_PROVINCES = createProvinceFlags('Morocco', [


  {
    name: 'Republic of the Rif (Historic 1921–1926)',
    code: 'ma-rif',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_the_Rif_Republic.svg',
    tags: [],
    status: ""
  },
  {
    name: 'Tangier International Zone (Historic 1925–1956)',
    code: 'ma-tan',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_the_Tangier_International_Zone.svg',
    tags: [],
    status: ""
  },
  {
