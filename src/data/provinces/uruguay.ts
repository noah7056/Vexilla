...
export const URUGUAY_PROVINCES = createProvinceFlags('Uruguay', [
  {
    name: 'Montevideo',
    code: 'uy-mvd',
    image: 'Flag_of_Uruguay.svg',
    aliases: ['Departamento de Montevideo', 'Capital of Uruguay'],
    tags: [],
    status: ""
  },
  {
  ...
  },
  {
    name: 'Tacuarembó',
    code: 'uy-ta',
    image: 'Bandera_de_Tacuaremb%C3%B3.svg',
    aliases: ['Tacuarembo', 'Departamento de Tacuarembo', 'Departamento de Tacuarembó'],
    tags: [],
    status: ""
  },
  {
